...
export const BlueprintContainer: React.FC<BlueprintContainerProps> = ({
  ...
  return (
    <div className="crt-screen h-screen flex items-center justify-center p-4 md:p-6 lg:p-10 box-border overflow-hidden relative">
      ...
      <div
        className={`blueprint-container haze-bloom w-full h-full ${fullWidth ? "" : "max-w-[1400px]"} border-[3px] border-white p-6 md:p-6 lg:p-8 flex flex-col gap-3 md:gap-4 lg:gap-5 relative bg-blueprint-blue/30 shadow-[0_0_20px_rgba(255,255,255,0.1)] box-border overflow-hidden`}
      >
